...
<header>
              ...
              <li class="nav-item dropdown show">
                <a href="#" class="navbar-nav-link dropdown-toggle text-light" data-toggle="dropdown" aria-expanded="true">
                  <div class="user-photo">
                    <img src="../../frontend/images/meprofile.jpg" alt="meprofile">
                  </div>
    ...
    <!--   For Toggle Mobile Nav -->
     <div class="toggle-user-menu" id = "toggle-user-menu">
        <ul>
          <li><a href="#"><div class="user-photo"><img src="../../frontend/images/meprofile.jpg" alt=""></div>admin@admin.com</a></li>
          <li><a href="">
...
<!--====== End Header Section======--><?php /**PATH D:\xampp\htdocs\Vue.js\job-portal\resources\views////admin/partials/navbar.blade.php ENDPATH**/ ?>