                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6 col-lg-6">
                        <div class="banner-img">
                            <img src="@/assets/images/home/index/01.png" alt="index">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="banner-part banner-2">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-6 col-lg-6">
                        <div class="banner-img">
                            <img src="@/assets/images/home/index/02.png" alt="index">
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-6">
                        <div class="banner-content">
                        ...
                        <li>
                            <div class="product-card">
                                <div class="product-media">
                                    ...
                                    <a class="product-image" href="product-video.html">
                                        <img src="@/assets/images/product/18.jpg" alt="product">
                                    </a>
                                    <div class="product-widget">
                                        <a title="Product Compare" href="compare.html" class="fas fa-random"></a>
                                        <a title="Product Video" href="https://youtu.be/9xzcVxSBbG8" class="venobox fas fa-play" data-autoplay="true" data-vbtype="video"></a>
                        ...
                        <li>
                            <div class="product-card">
                                <div class="product-media">
                                    ...
                                    <a class="product-image" href="product-video.html">
                                        <img src="@/assets/images/product/19.jpg" alt="product">
                                    </a>
                                    <div class="product-widget">
                                        <a title="Product Compare" href="compare.html" class="fas fa-random"></a>
                                        <a title="Product Video" href="https://youtu.be/9xzcVxSBbG8" class="venobox fas fa-play" data-autoplay="true" data-vbtype="video"></a>
                        ...
                        <li>
                            <div class="product-card">
                                <div class="product-media">
                                    ...
                                    <a class="product-image" href="product-video.html">
                                        <img src="@/assets/images/product/20.jpg" alt="product">
                                    </a>
                                    <div class="product-widget">
                                        <a title="Product Compare" href="compare.html" class="fas fa-random"></a>
                                        <a title="Product Video" href="https://youtu.be/9xzcVxSBbG8" class="venobox fas fa-play" data-autoplay="true" data-vbtype="video"></a>
                ...
                <div class="col-lg-12">
                    <div class="testimonial-slider slider-arrow">
                        ...
                        <div class="testimonial-card">
                            ...
                            <img src="@/assets/images/avatar/02.jpg" alt="testimonial">
                        </div>
                        <div class="testimonial-card">
                            <i class="fas fa-quote-left"></i>
                            <p>Lorem ipsum dolor consectetur adipisicing elit neque earum sapiente vitae obcaecati magnam doloribus magni provident ipsam</p>
                            ...
                            <img src="@/assets/images/avatar/03.jpg" alt="testimonial">
                        </div>
                        <div class="testimonial-card">
                            <i class="fas fa-quote-left"></i>
                            <p>Lorem ipsum dolor consectetur adipisicing elit neque earum sapiente vitae obcaecati magnam doloribus magni provident ipsam</p>
                            ...
                            <img src="@/assets/images/avatar/04.jpg" alt="testimonial">
                        </div>
                    </div>
                </div>
            </div>
