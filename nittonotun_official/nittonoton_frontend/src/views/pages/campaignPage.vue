...
<template>
    <div>
       <BannerPart :title="'Campaign Page'"/>
  ...
  <div class="container">
    <div class="row">
                    ...
                    <div class="col" v-for="(campaignProduct, index) in campaignProducts" :key="index">
                        <div class="product-card">
                          <div class="product-media">
                                 <router-link :to="{name: 'campaignDetailsPage', params : { campaignId: campaignProduct.pivot.campaign_id, productId : campaignProduct.pivot.product_id }}" class="product-image">
                            ...
                            <div class="product-content">
                                <h6 class="product-name">
                                  <router-link :to="{name: 'campaignDetailsPage', params : { campaignId: campaignProduct.pivot.campaign_id, productId : campaignProduct.pivot.product_id }}">{{ campaignProduct.name }}</router-link>
                                </h6>
                                <template v-if="campaignProduct.campaign_product_prices.length > 0">
                                    <span class="text-danger">প্রথমে ওয়েট সিলেক্ট করুন</span>
                                  <router-link :to="{
        ...
        <section class="inner-section shop-part" v-else>
           <div class="container">
                <h1 class="text-danger">The Campaign Offer Is Close</h1>
           </div>
        </section>
        <!--=====================================
                    SHOP PART END
