<template>
    <div>
        <div class="container my-5">
            ...
            <p>Thank you for shopping at Nittonoton.</p>
            ...
            <li>
            <p><strong>Website</strong> refers to Nittonoton, accessible from <a href="Nittonoton.com.bd" rel="external nofollow noopener" target="_blank">Nittonoton.com.bd</a></p>
            </li>
            <li>
            ...
            <ul>
            <li>By email: info.Nittonoton@gmail.com</li>
            </ul>
