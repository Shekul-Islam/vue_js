...
// const cityError = ref('');
// const townError = ref('');
// const relFirstNameError = ref('');
// const relLastNameError = ref('');
// const relPhoneNumberError = ref('');
// const relLocationError = ref('');
                  ...
                  <div class="col-md-12">
                    <div class="arrow-steps clearfix">
                      <div class="step current">
                        <span class="step-text">Selected Job Title</span>
                      </div>
